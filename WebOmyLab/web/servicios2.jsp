    ...
    <head>
     ...
     <body>
        <div id="all">
            ...
            String SQL1="select * from cliente where nro_documento="+nro;
            PreparedStatement st1=con.prepareStatement(SQL1);
            ResultSet resultado1=st1.executeQuery();
          %> 
          <!-- Top bar-->
          <div class="top-bar">
            <div class="container">
              ...
              <div class="container"><a href="index2.jsp" class="navbar-brand home"><img src="img/LogoOmylab.png" width=200 height=50 alt="Logo del laboratorio" class="d-none d-md-inline-block"><span class="sr-only">Página principal de Laboratorio OMYLAB</span></a>
                ...
                <div id="navigation" class="navbar-collapse collapse">
                  <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item nav-link active"><a href="servicios2.jsp?id=<%= request.getParameter("id")%>"  class="nav-item nav-link">Servicios</a></li>
