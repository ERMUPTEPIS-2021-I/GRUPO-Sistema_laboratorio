          ...
          <div id="content">
            <div class="container">
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="box">
                    <h2 class="text-uppercase">Reservar orden</h2>
                    <p class="lead">Reserva una orden con los análisis que necesites</p>
                    <hr>
                    <!-- comment
                    <form>
                      ...
                      <div class="text-center">
                       ...
                       -->
                      <form action="" method="post" style="width: 500px; height: 160px">
                        <table>
                        ...
                        <tr>
                            <td>ESTADO:&nbsp; </td>  
                            <td><input type="text" readonly="" name="txtest" value="Reserva"/></td>
                        </tr>
                        <tr><td><br></td></tr>
                        </table>
...
<%
       ...
       if(doc!=null && fec!=null && est!=null){
           ...
           tipo2="Reservo Orden";
           accion= nom+" "+ape+" reservo la orden: Nro:"+idO;
           PreparedStatement rs=con.prepareStatement("insert into historial_cliente(fecha,"
                   + " tipo,"+"accion,"+"nro_documento) values('"+fech2+"','"+tipo2+"','"+accion+"','"+doc+"')");
           rs.executeUpdate();
